...
def send():
    ...
    if(e.get()=='hi'):
        ...
        text.insert(END, "\n" + "Bot:Ok", webbrowser.open("https://classroom.google.com/u/0"))
        ...
        text.insert(END, "\n" + "Bot:Ok", webbrowser.open("https://wss.mahadiscom.in/wss/wss?uiActionName=getViewPayBill"))
    else:
...
send = Button(root,text='SEND',bg='pink',width=30,height=4,command = send).grid(row=1,column=1)
